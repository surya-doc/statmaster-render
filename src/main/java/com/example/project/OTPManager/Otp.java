...
public class Otp {
    ...
    public Integer generateOtp(String email) throws ResoruceNotFoundException {
        EmployeeDetails employee = this.employeeDetailsRepository.findByEmail(email);
        System.out.println(employee);
        if(employee == null){
            throw new ResoruceNotFoundException("Employee doesn't Exists");
        }
