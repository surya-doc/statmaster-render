...
public class EmployeeDetailsController {
	...
	public String updateEmployeePassword(@RequestBody EmployeeDetails employeeDetail) throws ResoruceNotFoundException {
		EmployeeDetails emp = employeeDetail;
		return employeeDetailsService.checkForPasswordUpdate(emp.getEmail(), emp.getPassword());
	}
